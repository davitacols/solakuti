...
import { getArticles, getCategoryArticles, getLatestArticles, getTrendingArticles } from "@/lib/api";
import { categories, categoryToSlug, slugToCategory } from "@/lib/utils";
...
export default async function CategoryPage({ params }: CategoryPageProps) {
  ...
  const [allArticles, categoryArticles, latestArticles, trendingArticles] = await Promise.all([
    getArticles(),
      ...
      <section className="bg-[#111] text-white">
        <div className="container-page py-12 lg:py-16">
          ...
          <p className="mt-5 max-w-2xl text-lg leading-8 text-white/64">
            The latest reporting, analysis and context from Solakuti's {category.toLowerCase()} coverage.
          </p>
